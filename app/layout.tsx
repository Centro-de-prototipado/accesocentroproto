        ...
        <div className="flex min-h-screen">
          ...
          <aside className="w-64 bg-card border-r border-border hidden md:block shrink-0">
            ...
            <nav className="p-4 space-y-2">
              ...
              <Link href="/logs" className="block px-4 py-3 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">Historial</Link>
          ...
          <main className="flex-1 bg-background min-w-0">
            ...
            <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border flex items-center justify-around py-2 md:hidden">
              ...
              <Link href="/logs" className="flex flex-col items-center gap-1 text-xs text-muted-foreground hover:text-primary transition-colors p-2">
